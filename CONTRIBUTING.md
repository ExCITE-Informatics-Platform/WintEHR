...
We welcome contributions to the WintEHR project! This guide outlines the high-level process for contributing. For detailed development protocols, coding standards, and system operational guidelines, please refer to the `CLAUDE.md` [NEED TO ADD LINK] file.
...
4.  **Code Standards**: Adhere to the code quality standards and Git commit standards outlined in `CLAUDE.md` [NEED TO ADD LINK].

5.  **Testing**: Ensure your changes are thoroughly tested. Information on running tests can be found in `CLAUDE.md` [NEED TO ADD LINK].

6.  **Documentation**: Keep documentation up-to-date. The documentation system and workflow are described in `CLAUDE.md` [NEED TO ADD LINK].
